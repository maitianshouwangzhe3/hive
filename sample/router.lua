...
if not hive.init_flag then
    ...
    local args, optind = alt_getopt.get_opts(hive.args or {}, "", long_opts);
    ...
    hive.print = log_info;
    _G.print = log_debug;
    socket_mgr = hive.create_socket_mgr(args.connections or 64);
